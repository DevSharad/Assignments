...
public class C9 {
	...
	public static void main(String[] args) {
		...
		map.put(new Employee(100, "sharad", 12212, "computer", "sangli"),100);
		map.put(new Employee(121, "vaibhav", 23422, "computer", "kolhapur"),121);
		map.put(new Employee(3, "amol", 4522, "computer", "ahamednagar"),3);
		map.put(new Employee(200, "bablu", 222343, "computer", "sangli"),200);
		map.put(new Employee(211, "rushi", 89987, "computer", "pune"),211);
